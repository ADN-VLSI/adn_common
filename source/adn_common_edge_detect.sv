...
module adn_common_edge_detect #(
    ...
    // System clock input
    input  logic clk_i,        // Active-low asynchronous reset
    input  logic rst_n_i,      // Input signal to be monitored for edges
    input  logic signal_in_i,  // Output pulse indicating edge detection
